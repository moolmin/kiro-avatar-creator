          ...
          <div className="text-center">
            ...
            <div className="mt-12 sm:mt-16">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4 sm:gap-6 max-w-4xl mx-auto">
                {/* Placeholder avatar examples */}
                {[1, 2, 3, 4, 5].map((i) => (
                  <div key={i} className="aspect-square bg-primary-purple/10 rounded-xl border-2 border-dashed border-primary-purple/30 flex items-center justify-center">
                    <svg className="w-8 h-8 text-primary-purple/50" fill="currentColor" viewBox="0 0 20 24">
                      ...
                      <path d="M10.9614 10.4413C9.97202 10.4413 9.82422 9.25893 9.82422 8.55407C9.82422 7.91791 9.93824 7.4124 10.1542 7.09197C10.3441 6.81003 10.6158 6.66699 10.9614 6.66699C11.3071 6.66699 11.6036 6.81228 11.8128 7.09892C12.0511 7.42554 12.177 7.92861 12.177 8.55407C12.177 9.73591 11.7226 10.4413 10.9616 10.4413H10.9614Z" fill="white" />
                      <path d="M15.0318 10.4413C14.0423 10.4413 13.8945 9.25893 13.8945 8.55407C13.8945 7.91791 14.0086 7.4124 14.2245 7.09197C14.4144 6.81003 14.6861 6.66699 15.0318 6.66699C15.3774 6.66699 15.6739 6.81228 15.8831 7.09892C16.1214 7.42554 16.2474 7.92861 16.2474 8.55407C16.2474 9.73591 15.793 10.4413 15.0319 10.4413H15.0318Z" fill="white" />
                    </svg>
                  </div>
                ))}
              </div>
              <p className="text-sm text-gray-600 mt-4">
                Examples coming soon! Start creating your own unique avatar.
              </p>
            </div>
          </div>
        </div>
